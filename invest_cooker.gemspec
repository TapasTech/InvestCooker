Gem::Specification.new do |s|
  ...
  s.files       = [
    ...
    'lib/monkey_patches/grapthql.rb',

    'lib/dsl/information_tags_dsl.rb',
    'lib/dsl/market_period_dsl.rb',
    'lib/dsl/search_filter_dsl.rb',

    'lib/concerns/remember.rb',
    'lib/concerns/cache_by_params.rb',
